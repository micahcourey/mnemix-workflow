...
- `011` [`focus standards support on OpenAPI, AsyncAPI, and JSON Schema`](./011-focus-standards-support-on-openapi-asyncapi-and-json-schema.md): keep first-class standards support focused on API and data contracts
